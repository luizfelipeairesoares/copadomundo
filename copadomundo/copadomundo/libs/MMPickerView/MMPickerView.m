...
@property (copy) void (^onActionCompletion)(NSString *);
...
+(void)showPickerViewInView: (UIView *)view
                withStrings: (NSArray *)strings
                withOptions: (NSDictionary *)options
           actionCompletion: (void(^)(NSString *actionCompletion))actionCompletion
    ...
    [[self sharedView] initializePickerViewInView:view
                                      ...
                                      withOptions:options];
    [[self sharedView] setPickerHidden:NO callBack:nil];
    [self sharedView].onActionCompletion = completion;
    [self sharedView].onDismissCompletion = actionCompletion;
    [view addSubview:[self sharedView]];
}
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
    ...
    _pickerViewCancelBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(cancelDismiss)];
  ...
  [_pickerViewDoneBarButtonItem setTintColor:buttonTextColor];
    [_pickerViewCancelBarButtonItem setTintColor:buttonTextColor];
...
-(void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
  if (self.objectToStringConverter == nil) {
    self.onActionCompletion ([_pickerViewArray objectAtIndex:row]);
  } else{
    self.onActionCompletion (self.objectToStringConverter ([self selectedObject]));
  }
}
